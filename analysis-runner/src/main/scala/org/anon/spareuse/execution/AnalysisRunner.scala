...
import org.anon.spareuse.execution.analyses.impl.{DynamicFeatureExtractor, MvnConstantClassAnalysisImpl, MvnDependencyAnalysisImpl, MvnPartialCallgraphAnalysisImpl}
...
class AnalysisRunner(private[execution] val configuration: AnalysisRunnerConfig)
  ...
  override def initialize(): Unit = {
    ...
    AnalysisRegistry.registerRegularAnalysis(DynamicFeatureExtractor, () => new DynamicFeatureExtractor)
